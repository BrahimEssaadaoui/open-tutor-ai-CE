...
description: Use when working in a Svelte project and asked to write, edit, or analyze a Svelte component or module. Covers reactivity, event handling, styling, integration with libraries and more.
---
